...
const Scratch = {
    ...
    TargetType: require('../../extension-support/target-type')
}
...
class LMSUtils {
    ...
    commentBool(args) {
        return Cast.toBoolean(args.INPUTB);
    }
    ...
    setSpriteSVG(args, util) {
        try {
            this.runtime.renderer.updateSVGSkin(util.target.sprite.costumes[args.INPUTA - 1].skinId, args.INPUTB);
        } catch (error) {
            return;
        }
